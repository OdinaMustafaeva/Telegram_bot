...
def future_window_fun(message):
    ...
    def key_button():
        ...
        login_or_sign.add(KeyboardButton(f"Add future Message➕"),
                          KeyboardButton("delete message🗑"), KeyboardButton("back 🔙"))
        return login_or_sign

    simple_bot.send_message(message.chat.id, f"Welcome Future message 📩",

...
def goal_window_fun(message):
    ...
    def key_button():
        ...
        login_or_sign.add(KeyboardButton(f"See goals👁"),
                          KeyboardButton("Remove goals❌"), KeyboardButton("Add goals⏬"), KeyboardButton("back 🔙"))
        return login_or_sign

    simple_bot.send_message(message.chat.id, f" Welcome Your Goals🦾",
